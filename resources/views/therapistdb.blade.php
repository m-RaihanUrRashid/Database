...
<body>
    ...
    <h1 style="text-align: center;" class="load">Welcome Therapist</h1> <br> <br> <br>


    <div style="text-align: center" class="load";>
        <img src="/img/Therapy.png" width="300px" height="300px" alt="Therapy">
    </div> <br>


    <h2 style="text-align: center;" class="load">Please hover upward to navigate.</h2>